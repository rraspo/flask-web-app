...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='mysql://db_admin:db2018@localhost/pythonwebapp_testing'
        )
        return app
...
class TestModels(TestBase):
    ...
    def test_employee_model(self):
        '''
        Test number of records in employees table
        '''
        self.assertEqual(Employee.query.count(), 2)

    def test_department_model(self):
        '''
        Test number of records in departments table
        '''
...
class TestErrorPages(TestBase):
    ...
    def test_404_not_found(self):
        response = self.client.get('/noregisteredurl')
